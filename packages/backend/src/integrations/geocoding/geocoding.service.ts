 ...
 * Geocoding Service
 * 
 * Сервис для геокодирования (поиск координат по названию города).
 * Использует встроенный список городов для быстрого поиска.
 */
...
export class GeocodingService {
   ...
   */
  geocode(cityName: string): GeocodedLocation | null {
   ...
   */
  getQuickPickCities(limit = 6): GeocodedLocation[] {
    return getQuickPickCities(limit);
  }
}
